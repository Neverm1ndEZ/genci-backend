...
import { generateRandomCode, errorHelper, logger, getText, signConfirmToken, sendLinkToEmail } from '../../../../utils/index.js';
...
export default async (req, res) => {
  ...
  await sendLinkToEmail(req.body.email, user.name, emailCode, user.language, 'newCode', req, res);
  ...
  const confirmCodeToken = signConfirmToken(user._id);
